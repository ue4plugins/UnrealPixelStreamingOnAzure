...
[CmdletBinding()]
Param (
    [Parameter(Position=0, Mandatory=$false, HelpMessage = "The current version")]
    [int] $version = 1
)
...
#base variables
#####################################################################################################
$mmServiceFolder = "C:\Unreal_$version\WindowsNoEditor\Engine\Source\Programs\PixelStreaming\WebServers\Matchmaker"
